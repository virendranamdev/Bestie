   ...
   $data = json_decode($jsonArr, true);
    ...
    if (!empty($data)) {
     ...
     //   echo "statrt date-".$fromdt;
        ...
        $result = $obj->getRecognizedTopSender($client, $fromdt, $enddte,$department,$location);
                                    ...
                                    '.$username.'
                                        <div class="progress mt15">
                                            <div class="progress-bar progress-bar-striped active" role="progressbar"
                                                 aria-valuenow="'.$usersender.'" aria-valuemin="0" aria-valuemax="100" style="width:'.$percent.'%"> '.$usersender.'
                                            </div>
                                        </div>
                                    </div>
                                </div><hr>';

...
if (!empty($jsonArr['clientid'])) {
    ...
    extract($jsonArr);
    if (strtolower($comment) != $comments->filterWords($comment)) {
        $response['success'] = 0;
...
//print_r($myArray);
        ...
        $fullpath = '';
        $flag_name = "Comment : ";
        $BY = $createComment['posts'][0]['firstname'] . " " . $createComment['posts'][0]['middlename'] . " " . $createComment['posts'][0]['lastname'];
